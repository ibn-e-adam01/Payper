...
import PurchaseProductNavbar from '../components/PurchaseProductNavbar.jsx';
...
const PurchasePortal = () => {
  ...
  return (
    ...
    <PurchaseProductNavbar  MenuIsOpen={MenuIsOpen} setMenuIsOpen={setMenuIsOpen}/>
    <PurchasePortalMain  MenuIsOpen={MenuIsOpen} setMenuIsOpen={setMenuIsOpen}/>
